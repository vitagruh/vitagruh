...
- 📅 **Встроенный календарь** — выбор даты через интерактивный календарь Telegram
...
- 📜 **История поисков** — просмотр последних маршрутов
- 💓 **Heartbeat** — периодические уведомления о работе бота
